    ...
    public partial class Orden : CommonObj, IAccessDB<Orden>, ITable, IAutoIncrement
    {
        ...
        private string[] list_values()
        {
            ...
            string[] values = { 
                                ...
                                (this.IsNew?"":_columns[1] + "=")+String.Format("{0}",this._cliente_id),//formato cadena ''
                                (this.IsNew?"":_columns[2] + "=")+String.Format("{0}",this._empleado_id),//formato cadena ''                                
        ...
        public string SqlString
        {
            get
            {
                ...
                return String.Format(sqliu, this.TableName, (this.IsNew ? String.Join(",", _columns) : vvalues), (this.IsNew ? vvalues : String.Format("orden_id = {0}", this.OrdenId)));
            }
        }

        public void setKeyValue(object valueId)
        {
            this._orden_id = (int) valueId;
        }
